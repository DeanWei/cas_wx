...
<div id="msg" class="errors">
  ...
  <div class="box fl-panel" id="login">
			<form:form action="/cas_debug/login" method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
                ...
                <!-- <spring:message code="screen.welcome.welcome" /> -->
                    ...
                    <div class="row fl-controls-left">
						...
						<form:input cssClass="required" cssErrorClass="error" id="username" size="25" tabindex="1" accesskey="${userNameAccessKey}" path="username" autocomplete="false" htmlEscape="true" value="${username}" />
						</c:if>
                    </div>
                    <div class="row fl-controls-left">
						...
						<form:password cssClass="required" cssErrorClass="error" id="password" size="25" tabindex="2" path="password"  accesskey="${passwordAccessKey}" htmlEscape="true" autocomplete="off" value="${openid}" />
                    </div>
                    <div class="row check">
                    ...
                    <div class="row btn-row">
                        ...
                        <input class="btn-submit" name="submit1" accesskey="l" value="<spring:message code="screen.welcome.button.login" />" tabindex="4" type="submit" />
